		...
		React.createElement(ScrollView, {
			...
			React.createElement(View, { style: styles.card },
				...
				React.createElement(View, { style: styles.textContainer },
					React.createElement(Text, { style: styles.title }, "Password Reset Complete!"),
					React.createElement(Text, { style: styles.subtitle }, "Your password has been successfully reset."),
